...
extension GameScene {
       ...
       private func moveBackgroundLayers() {
       ...
       private func forceFieldActions() {
       ...
       private func spritesCovergeOnPlayer() {
       ...
       private func incrementPersistenceCounter() {
       ...
       private func moveAndFadePointLabels() {

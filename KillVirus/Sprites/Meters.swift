...
class  HealthMeter:SKSpriteNode
{
...
//class HealthMeterLabel:SKLabelNode
//{
//    let initialTextPrefix = "Health Points: "
//
//    override init(fontNamed fontName: String?) {
//        
//        if let name = fontName {
//            super.init()
//            self.text = initialTextPrefix
//            self.fontSize = 24.0
...
//    }
//  
//    func updatePoints(_ healthPoints:Int)->Void
//    {
//        self.text = initialTextPrefix + String(healthPoints)
//    }
